...
Generated: 2026-03-19T13:04:02.833Z
Test ID: 2026-03-19T13-03-53-926Z
...
| Database Connectivity | FAIL | PASS |
...
- Results:
  - {"endpoint":"/api/projects","status":200,"contentType":"application/json","hasData":true,"dataCount":2,"isError":false}
  - {"endpoint":"/api/prds","status":200,"contentType":"application/json","hasData":true,"dataCount":2,"isError":false}
  - {"endpoint":"/api/users/me","status":200,"contentType":"application/json","hasData":true,"dataCount":2,"isError":false}
  - {"endpoint":"/api/dashboard/stats","status":200,"contentType":"application/json","hasData":true,"dataCount":2,"isError":false}

### EDGEFUNCTIONS
- Status: PARTIAL
- Details: 3/4 API tests passed
- Results:
  - {"test":"Create Project (POST)","endpoint":"/api/projects","method":"POST","status":200,"expected":201,"passed":false,"hasResponseData":true,"error":"Expected 201, got 200"}
  - {"test":"List Projects (GET)","endpoint":"/api/projects","method":"GET","status":200,"expected":200,"passed":true,"hasResponseData":true,"error":null}
  - {"test":"Get PRD Templates","endpoint":"/api/templates","method":"GET","status":200,"expected":200,"passed":true,"hasResponseData":true,"error":null}
  - {"test":"AI Model List","endpoint":"/api/models","method":"GET","status":200,"expected":200,"passed":true,"hasResponseData":true,"error":null}
...
### Test Execution Time
- Start: 2026-03-19T13:04:02.833Z
