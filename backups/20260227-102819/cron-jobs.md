...
```
# Email monitoring (every 30 minutes during business hours)
*/30 8-18 * * 1-5 /Users/clawdia/.openclaw/workspace/scripts/check-emails.sh
...
- `check-emails.sh` - Monitor IHS Towers and priority emails
...
3. `check-emails.sh` - IHS Towers email monitoring
