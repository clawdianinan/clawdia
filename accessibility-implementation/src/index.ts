 ...
 */
export function setupKeyboardShortcuts(additionalShortcuts?: Array<{
  key: string;
  ctrlKey?: boolean;
  shiftKey?: boolean;
  altKey?: boolean;
 ...
 */
function showKeyboardShortcutsDialog(shortcuts: any[]): void {
 ...
 */
function formatShortcutDisplay(shortcut: any): string {
  const parts = [];
 ...
 */
export function announcePRDProgress(step: number, total: number, message?: string): void {
 ...
 */
export function announceCreditUsage(creditsUsed: number, creditsRemaining: number): void {
 ...
 */
export function showFormFieldError(fieldId: string, errorMessage: string): void {
 ...
 */
export function clearFormFieldError(fieldId: string): void {
